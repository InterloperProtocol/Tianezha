...
import { POST } from "@/app/api/internal-admin/bolclaw/profiles/[guestId]/hide/route";

describe("/api/internal-admin/bolclaw/profiles/[guestId]/hide", () => {
  beforeEach(() => {
  ...
  it("returns 401 when the owner is not authenticated", async () => {
    ...
    const request = new NextRequest("https://example.com/api/internal-admin/bolclaw/profiles/test/hide", {
      method: "POST",
