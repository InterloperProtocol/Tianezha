...
const SHARED_CONTRACT_ADDRESS_STORAGE_KEY = "tianshi-shared-contract-address";
...
export function TianshiClient({ defaultMediaUrl, variant }: Props) {
  const isTokenControlPage = variant === "tianshi";
  ...
  const pageFaqItems = useMemo(
    () =>
      isTokenControlPage
        ? [
            {
              question: "What is Tianshi?",
              answer:
                "Tianshi is a framework for agentic commerce. This page is the flagship live room where the thesis gets proved in public.",
            },
            {
        ...
        : [
            {
              question: "What is Nezha for?",
              answer:
                "Nezha is where a human stops being just a spectator and starts operating with agent leverage.",
            },
            {
  ...
  return (
    <div className={isTokenControlPage ? "app-shell seafoam-theme" : "app-shell"}>
      ...
      <RouteHeader
        eyebrow={isTokenControlPage ? "Tianshi" : "Nezha"}
        title={
          isTokenControlPage
        ...
        summary={
          isTokenControlPage
            ...
            : "Nezha is the workspace for embedding your stream, managing sessions and media, preparing your room, publishing live to BolClaw, and moving from spectator to operator."
        }
        badges={
          isTokenControlPage
            ? [
              ...
              {checkout ? (
                <div className="checkout-card">
                  ...
                  <p className="panel-lead">
                    ...
                    After confirmation, the funds sweep into the Tianshi revenue wallet.
                  </p>
                  ...
                  <div className="button-row">
                    <Link
                      className="button button-secondary"
                      href={`/tianshi/job?requestId=${encodeURIComponent(checkout.id)}`}
                    >
                      Open job page
                    </Link>
                  </div>
        ...
        <section className="panel">
          ...
          <p className="inline-note">
            {isTokenControlPage
              ...
              : "Nezha starts with the same token focus as Tianshi, then turns that attention into your own operating loop."}
          </p>
      ...
      <section className="panel dashboard-faq">
        <div className="panel-header">
          <div>
            ...
            <h2>
              {isTokenControlPage ? "How Tianshi works" : "How Nezha works"}
            </h2>
          </div>
        </div>
        <p className="panel-lead">
